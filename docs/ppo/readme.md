...
## Création de jeux vidéo avec Godot

## Introduction
Ce document se veut comme un site pour les élèves du cours "Projet personnel d'orientation" qui souhaitent apprendre à créer des jeux vidéo avec Godot. Il est conçu pour être utilisé avec le logiciel Godot, qui est un moteur de jeu open source et gratuit.
...
Nous avons divisé ce site en plusieurs ateliers, chacun couvre un jeu avec des mécaniques de jeu différentes. Chaque atelier est conçu pour être suivi étape par étape, avec des explications détaillées et des exemples de code pour t'aider à comprendre comment les choses fonctionnent. 
